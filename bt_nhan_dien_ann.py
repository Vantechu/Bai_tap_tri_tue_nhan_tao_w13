# -*- coding: utf-8 -*-
"""BT_NHAN_DIEN_ANN.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1xIrQ9jBepj-yUwOV8A4uUNxrHZTzXXsp
"""
...
plt.title("Model dự đoán (1: Chuong, 0: Ko phải Chuong): " + str(np.argmax(model.predict(img))))
plt.imshow(cv2.cvtColor(x_pre, cv2.COLOR_BGR2RGB), cmap=plt.get_cmap('gray'))

plt.imshow(cv2.cvtColor(x_pre_1, cv2.COLOR_BGR2RGB))
print(x_pre_1.shape)
img1 = x_pre_1.reshape(1,-1)
img1 = img.astype('float32')
img1 /= 255

plt.title("Model dự đoán (1: Chuong, 0: Ko phải Chuong): " + str(np.argmax(model.predict(img1))))
